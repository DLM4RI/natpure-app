      ...
      <v-col cols="12" md="8" lg="6">
        <v-card class="pa-8 text-center bg-surface" elevation="4" rounded="xl">
          ...
          <v-card variant="outlined" class="text-left mb-8 rounded-lg" color="primary">
            <v-card-text>
              <h3 class="text-h6 font-weight-bold mb-4">Detalles de Factura #{{ numeroFactura }}</h3>
              <v-divider class="mb-4"></v-divider>
              ...
              <div class="d-flex justify-space-between">
                ...
                <span class="text-h6 font-weight-bold text-success">{{ montoPagado.toFixed(2) }}€</span>
              </div>
            </v-card-text>
          </v-card>
...
const procesarPago = () => {
  ...
  setTimeout(() => {
    ...
    numeroFactura.value = Math.floor(Math.random() * 1000000).toString().padStart(6, '0')
