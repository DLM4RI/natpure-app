<template>
  <v-container class="py-8">
          ...
          <v-row align="center">
            ...
            <v-col cols="12" sm="4" md="4">
              ...
              <div class="text-body-2 text-medium-emphasis">
                Precio Unitario: {{ item.precio.toFixed(2) }} COP
              </div>
            </v-col>
            ...
            >
              ...
              ></v-btn>
              <span class="mx-4 text-h6 font-weight-bold">{{
                item.cantidad
              }}</span>
              <v-btn
                icon="mdi-plus"
            ...
            >
              <div class="text-h6 font-weight-bold text-primary">
                {{ (item.precio * item.cantidad).toFixed(2) }} COP
              </div>
              <v-btn
                icon="mdi-delete"
                variant="text"
    ...
    <v-row v-else class="text-center py-16">
      <v-col cols="12">
        <v-icon size="80" color="medium-emphasis" class="mb-6"
          >mdi-cart-outline</v-icon
        >
        <h2 class="text-h4 text-primary mb-4">Tu carrito está vacío</h2>
        <p class="text-body-1 text-medium-emphasis mb-8">
          ¡Añade algunos productos fantásticos antes de proceder al pago!
        </p>
        <v-btn color="primary" size="large" to="/catalogo" variant="elevated"
          >Explorar Catálogo</v-btn
        >
      </v-col>
    </v-row>
  </v-container>
