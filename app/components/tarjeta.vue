<template>
  ...
  >
    ...
    >
      ...
      <v-card-title class="text-h6 font-weight-black text-primary px-4 pt-4 pb-1 text-truncate">
        {{ producto.nombre }}
      </v-card-title>
    </div>

    <v-card-subtitle class="text-body-2 mb-2 px-4 text-medium-emphasis text-truncate">
    ...
    <v-expand-transition>
      <div v-show="mostrar">
        <v-divider></v-divider>
        <v-card-text class="pa-4 bg-background text-medium-emphasis text-body-2">
...
import { CartAdd, ChevronDown, ChevronUp } from "@boxicons/vue";
